...
<template>
  ...
  >
    ...
    <!-- Mobile Center: Room name and progress -->
    <div class="flex items-center gap-2 sm:hidden flex-1 justify-center">
      ...
      <div class="flex items-center gap-1">
        <div v-for="(room, index) in roomProgress" :key="room.id" class="flex items-center">
          ...
          >
            <span v-if="room.isCompleted">🚪</span>
            <span v-else-if="room.isCurrent">🚪</span>
            <span v-else>🔒</span>
          </div>

          <!-- Tiny connecting dot (not for last room) -->
          <div
    ...
    >
      ...
      <!-- Room Progress Indicator - Only for laptop and large screens -->
      <div class="hidden laptop:flex items-center gap-1 large:gap-2">
        <div v-for="(room, index) in roomProgress" :key="room.id" class="flex items-center">
          ...
          <!-- Connecting Arrow (not for last room) -->
          <div
            v-if="index < roomProgress.length - 1"
