...
<template>
  <div class="w-full h-full flex flex-col items-center justify-center bg-dhl-yellow text-gray-900 p-8">
    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a2/DHL_Logo.svg" alt="DHL Logo" class="w-64 mb-8"/>
    <h1 class="text-5xl font-bold font-delivery text-dhl-red mb-4 text-center">SYSTEMS RESTORED!</h1>
    ...
    <p class="text-xl max-w-3xl text-center mt-8">
      Congratulations! Your team's expertise and quick thinking have neutralized the threat and restored full functionality to the DHL Global IT network.
    </p>
  </div>
</template>
